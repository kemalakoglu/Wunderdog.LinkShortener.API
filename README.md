# Wunderdog.LinkShortener.EventEmitter

Wunderdog.LinkShortener.API is API microservice which consumes UI requests.
...
## Install
    ...
    $ git clone https://github.com/kemalakoglu/Wunderdog.LinkShortener.API.git
    $ cd Wunderdog.LinkShortener.API
    $ npm install
